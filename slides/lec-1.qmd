...
![](images/lec-1/jupyter-edit.png){.absolute top="170" left="30" width="400" height="400"}

![](images/lec-1/jupyter-preview.png){.absolute .fragment top="150" right="80" width="450"}

![](images/lec-1/moon.png){.absolute .fragment bottom="110" right="130" width="300"}
...
::: {layout-ncol="2"}
![](images/lec-1/moon.png)

![](images/lec-1/sky.png)
:::
...
::: {layout="[1, 20]"}
![](images/lec-1/presentation-menu.png){width="41"}
...
::: {layout="[1, 20]"}
![](images/lec-1/presentation-chalkboard.png){width="41"}

Use the chalkboard button at the bottom left of the slide to toggle the chalkboard.
:::

::: {layout="[1, 20]"}
![](images/lec-1/presentation-notes-canvas.png){width="41"}
...
![](images/lec-1/overview-mode.png){.border}
...
![](images/lec-1/speaker-view.png){fig-align="center" style="border: 3px solid #dee2e6;" width="780"}
...
::: columns
::: {.column width="50%"}
![](images/lec-1/jupyter-edit.png){.border .border-thick}
:::

::: {.column width="50%"}
![](images/lec-1/jupyter-preview.png){.border .border-thick}
:::
:::
